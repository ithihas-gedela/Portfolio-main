    ...
    <footer className="bg-gray-900 text-white py-12 px-6">
      ...
      >
        ...
        <div className="flex justify-center gap-8 text-2xl text-gray-400">
          <a
            href="https://github.com/ithihas-gedela"
          ...
          <a
            href="https://www.linkedin.com/in/ithihas-gedela/"
            className="hover:text-purple-400 transition"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="mailto:gedelaithihas@gmail.com"
            className="hover:text-purple-400 transition"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <div className="border-t border-gray-700 pt-8">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} Ithihas. All rights reserved.
          </p>
        </div>
      </motion.div>
    </footer>
